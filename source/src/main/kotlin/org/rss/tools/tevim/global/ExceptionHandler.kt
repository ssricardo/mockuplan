...
import org.rss.tools.tevim.validation.AppException
import org.slf4j.LoggerFactory

@Aspect
class ExceptionHandler {

    @Pointcut("call(* org.rss.tools.tevim.parsing..*(..))")
    fun parsePhase() {
    }

    @Pointcut("within(org.rss.tools.tevim.Main)")
    fun fromMain() {
    }

    @Pointcut("execution(* org.rss.tools.tevim.Main.main(*))")
    fun mainCall() {
    }
    ...
    @AfterThrowing(value = "call(* org.rss.tools.tevim.render..*(..))", throwing = "e")
